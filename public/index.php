...
$app->router->get('/film/:id/review', [ReviewsController::class, 'createPage']);
$app->router->get('/my-reviews/:id', [ReviewsController::class, 'editPage']);
$app->router->post('/film/:id/review', [ReviewsController::class, 'create']);
$app->router->post('/my-reviews/:id', [ReviewsController::class, 'edit']);
$app->router->delete('/my-reviews/:id/delete', [ReviewsController::class, 'delete']);
